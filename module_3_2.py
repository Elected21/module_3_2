def send_email (message, recipient, sender = 'university.help@gmail.com'):
    ...
    if '@' not in (recipient or sender) or not (recipient.endswith('.com' '.ru' '.net'), sender.endswith('.com' '.ru' '.net')):
...
send_email('Это сообщение для проверки связи', 'vasyok1337gmail.ua')